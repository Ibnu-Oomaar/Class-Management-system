  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="leading-tight">
        ...
        <div className="text-sm font-bold text-[hsl(var(--foreground))]">Class 3C</div>
      </div>
    </div>
  );
}
...
function AppContent({ onLogin }: { onLogin: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--background))] text-[hsl(var(--foreground))] antialiased selection:bg-[hsl(var(--brand))]/20">
      <header className="sticky top-0 z-50 border-b border-[hsl(var(--border))]/80 bg-[hsl(var(--background))]/80 backdrop-blur-xl">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1 rounded-full border border-[hsl(var(--border))] bg-[hsl(var(--muted))] p-1">
              {languageOptions.map((option) => (
                <button
                  key={option.code}
                  type="button"
                  onClick={() => setLanguage(option.code as "en" | "so" | "ar")}
                  className={[
            ...
            <Button
              className="rounded-full px-5 shadow-[0_0_18px_rgba(20,175,95,0.2)] hover:-translate-y-0.5"
              onClick={onLogin}
            >
              {content.nav.login}
            </Button>
      ...
      <main>
        <section id="home" className="relative overflow-hidden border-b border-[hsl(var(--border))]">
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-6 py-20 md:grid-cols-[1.1fr_0.9fr] md:items-center md:py-28">
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Button variant="outline" size="lg" className="rounded-full px-6" onClick={onLogin}>
              ...
              <div className="flex flex-wrap gap-8 border-t border-[hsl(var(--border))] pt-8 text-sm text-[hsl(var(--muted-foreground))]">
                <div>
                  <div className="text-2xl font-black text-[hsl(var(--foreground))]">5</div>
                  <div>Leadership roles</div>
                </div>
                <div>
                  <div className="text-2xl font-black text-[hsl(var(--foreground))]">3C</div>
                  <div>Class identity</div>
                </div>
                <div>
                  <div className="text-2xl font-black text-[hsl(var(--foreground))]">100%</div>
        ...
        <section id="testimonials" className="bg-[hsl(var(--muted))]/40 py-20">
          ...
          <div className="rounded-4xl border border-[hsl(var(--border))] bg-[linear-gradient(135deg,rgba(20,175,95,0.08),hsl(var(--card)))] p-8 md:p-12">
            <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-center">
              ...
              <div className="rounded-3xl border border-[hsl(var(--border))] bg-[hsl(var(--background))] p-6 shadow-sm">
                ...
                <Button className="mt-6 w-full rounded-full">{content.contact.submit}</Button>
              </div>
            </div>
          </div>
        </section>
